...
public class TelaPrincipal extends JFrame {
  ...
  /** Construtor utilizado enquanto o sistema ainda nao tem login */
  public TelaPrincipal() {
    this(null);
  }

  /** Construtor preparado para receber o cliente autenticado quando a tela de login for desenvolvida */
